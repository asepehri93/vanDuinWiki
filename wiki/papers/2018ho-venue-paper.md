...
- **ReaxFF parameterization** against **QM reference data** for **NaSiOₓ** phases, **barriers**, **surface–ion–water** interactions, and **cluster dissociation** (see main article; SI lists parameters).

## Findings

- Provides the **machine-readable ReaxFF parameter set** used in the **2018 JPCC** study and downstream **sodium silicate / glass–water** work from the group.
