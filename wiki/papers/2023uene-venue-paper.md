...
The SI publishes the **full numeric ReaxFF coefficient set** for **B/Cl/N/H** chemistry in the BN ALD simulations. Training targets, validation metrics, and the reactive MD protocol are documented on **[[2024naoya-uene-j-phys-chem-reactive-force]]**; this PDF is the tabulated parameter disclosure for reproducibility.
