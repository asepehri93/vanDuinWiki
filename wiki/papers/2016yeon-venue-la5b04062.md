...
- **Reactive MD** with **ReaxFF**; **slab-on-slab** sliding with controlled **water** stoichiometry in the contact.
...
- **DOI:** `https://doi.org/10.1021/acs.langmuir.5b04062` (`papers/Yeon_Langmuir_2016.pdf`).
