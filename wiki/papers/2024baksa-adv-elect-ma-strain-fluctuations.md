...
Strain-gradient engineering can unlock measurable **polarization switching** pathways where uniform strain would retain higher barriers; fluctuations correlate with locally reduced barriers in the modeling presented.

## Limitations

Materials-specific generality (other wurtzites, defect chemistry, frequency-dependent switching) requires case-by-case validation; quantitative coercive fields in devices depend on microstructure not fully captured in idealized models.
